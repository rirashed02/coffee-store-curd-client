...
const AddCoffee = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24">
            ...
            <div>
                <h1 className="text-1xl font-bold mb-10">Add Coffees</h1>
                <form onSubmit={handleAddCoffee}>
                    <div className="md:flex mb-6">
                        ...
                        <div className="form-control ml-5 md:w-1/2">
                            ...
                            <label className="input-group">
                                <input type="text" name="quantity" placeholder="Enter you Quantity" className="input w-full" />
                            </label>
                        </div>
                    </div>
                    <div className="md:flex mb-6">
                        ...
                        <div className="form-control ml-5 md:w-1/2">
                            ...
                            <label className="input-group">
                                <input type="text" name="taste" placeholder="How does it Taste" className="input w-full" />
                            </label>
                        </div>
                    </div>
                    <div className="md:flex mb-6">
                    ...
                    <div className="md:flex mb-6">
                        <div className="form-control w-full">
                            ...
                            <label className="input-group">
                                <input type="text" name="photo" placeholder="Please Enter Photo url " className="input w-full" />
                            </label>
                        </div>
                    </div>
